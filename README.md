...
![AADMN pipeline](architecture.png)
...
Full detail is in [`methodology.md`](methodology.md) and
...
![Accuracy ablation](ablation.png)
...
├── scene_graph.png            ← scene graph on a dense frame
├── ablation.png               ← accuracy ablation chart
├── efficiency.png             ← throughput chart
└── attention_weights.png      ← trained GAT attention weights
```
